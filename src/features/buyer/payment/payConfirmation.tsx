...
// 🧩 Tách logic chính ra thành một Component riêng
        ...
        <CardContent className="space-y-6 p-8 text-gray-300 leading-relaxed">
          ...
          <div className="bg-gray-900/40 p-4 rounded-lg border border-gray-700 flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-gray-400">ID: {currentDataset.dataset_id}</p>
            </div>
...
// ✅ Component Page chính bao bọc bởi Suspense
export default function PaymentConfirmationPage() {
  return (
    <Suspense fallback={<div className="text-center mt-20 text-white">Đang tải...</div>}>
